...
class Solvated() extends Module {
  ...
  val fpuAM_oper = Seq(1.U                  , 0.U,   0.U,    0.U, 0.U,    1.U, 0.U, 0.U,                   1.U, 0.U, 1.U, 0.U, 1.U)
  val fpuAM_in11 = Seq(io.data(index1)      , 0.U, rijx2, rijx_y, 0.U,    rij, 0.U, 0.U, doubleToIEEE(1.0), 0.U, aXij_2, 0.U, io.in_solvE)
  val fpuAM_in12 = Seq(io.data(index2)      , 0.U, rijy2,  rijz2, 0.U, vdWr_i, 0.U, 0.U, Xij_2, 0.U, aXji_2, 0.U, partialSumSOLV)
  val fpuAM_in21 = Seq(io.data(index1 + 1.U), 0.U,   0.U,    0.U, 0.U,    rij, 0.U, 0.U, doubleToIEEE(1.0), 0.U, 0.U, 0.U, 0.U)
  val fpuAM_in22 = Seq(io.data(index2 + 1.U), 0.U,   0.U,    0.U, 0.U, vdWr_j, 0.U, 0.U, Xji_2, 0.U, 0.U, 0.U, 0.U)
  val fpuAM_in31 = Seq(io.data(index1 + 2.U), 0.U,   0.U,    0.U, 0.U,    0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U)
  val fpuAM_in32 = Seq(io.data(index2 + 2.U), 0.U,   0.U,    0.U, 0.U,    0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U)
  ...
  when(fpuAdd.io.resp.fire) {
    ...
    rij_vdWri := Mux(counter_1H(5), fpuAdd.io.resp.bits.result(0), rij_vdWri)
    rij_vdWrj := Mux(counter_1H(5), fpuAdd.io.resp.bits.result(1), rij_vdWrj)
    Xij_21 := Mux(counter_1H(8), fpuAdd.io.resp.bits.result(0), Xij_21)
    Xji_21 := Mux(counter_1H(8), fpuAdd.io.resp.bits.result(1), Xji_21)
    aXijXji := Mux(counter_1H(10), fpuAdd.io.resp.bits.result(0), aXijXji)
    io.out_solvE := Mux(counter_1H(12) && doSolveEnergy, fpuAdd.io.resp.bits.result(0), io.in_solvE)
    done_cal := Mux(counter_1H(12), true.B, done_cal)
  }
  ...
  val fpuM_in10 = Seq(0.U, rijx, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, Xij_21, 0.U, 0.U, 0.U)
  val fpuM_in11 = Seq(0.U, rijx, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, alpha_i, 0.U, 0.U, 0.U)
  val fpuM_in20 = Seq(0.U, rijy, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, Xji_21, 0.U, 0.U, 0.U)
  val fpuM_in21 = Seq(0.U, rijy, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, alpha_j, 0.U, 0.U, 0.U)
  val fpuM_in30 = Seq(0.U, rijz, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U)
  val fpuM_in31 = Seq(0.U, rijz, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U)
  ...
  when(fpuMul.io.resp.fire) {
    ...
    aXij_2 := Mux(counter_1H(9), fpuMul.io.resp.bits.result(0), aXij_2)
    aXji_2 := Mux(counter_1H(9), fpuMul.io.resp.bits.result(1), aXji_2)
  }
  ...
  val fpuD_in10 = Seq(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, rij_vdWri, Xij                  , 0.U, 0.U, 0.U, aXijXji, 0.U)
  val fpuD_in11 = Seq(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, lambda_i, doubleToIEEE(2.0), 0.U, 0.U, 0.U, rij2, 0.U)
  val fpuD_in20 = Seq(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, rij_vdWrj, Xji                  , 0.U, 0.U, 0.U, 0.U, 0.U)
  val fpuD_in21 = Seq(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, lambda_j, doubleToIEEE(2.0), 0.U, 0.U, 0.U, 0.U, 0.U)
  ...
  when(fpuDiv.io.resp.fire) {
    Xij := Mux(counter_1H(6), fpuMul.io.resp.bits.result(0), Xij)
    Xji := Mux(counter_1H(6), fpuMul.io.resp.bits.result(1), Xji)
    Xij_2 := Mux(counter_1H(7), fpuDiv.io.resp.bits.result(0), Xij_2)
    Xji_2 := Mux(counter_1H(7), fpuDiv.io.resp.bits.result(1), Xji_2)
    partialSumSOLV := Mux(counter_1H(11), fpuDiv.io.resp.bits.result(0), partialSumSOLV)
  }
