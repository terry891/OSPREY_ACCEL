...
import composer.{ComposerConstructor, ComposerCore, ComposerSystemsKey, CppGeneration}
...
class DecisionTreeDispatcher(composerCoreParams: ComposerConstructor, params: DTParams)(implicit p: Parameters)
  ...
  val respondingCore = composer_response_io.bits.data(31 + CoreIDLengthKey, 32)
