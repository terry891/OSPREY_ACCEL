...
class HalfNonBonded() extends Module {
  ...
  when ( (io.halfNonBondedTerms(2) === 1.U(32.W)) && (!io.useHydrogenEs && !io.useHydrogenVdw) ) {  //(useHydrogenNeither && isHydrogen)
    ...
    */
    ...
    when(fpuAdd.io.resp.fire) {
      ...
      io.out_esE := Mux(counter_1H(9) && (!(io.halfNonBondedTerms(2) === 1.U(32.W)) || io.useHydrogenEs), fpuAdd.io.resp.bits.result(0), io.in_esE)
      io.out_vdwE := Mux(counter_1H(9) && (!(io.halfNonBondedTerms(2) === 1.U(32.W)) || io.useHydrogenVdw), fpuAdd.io.resp.bits.result(1), io.in_vdwE)
    ...
    val fpuM_in10 = Seq(0.U, rijx, chargei, 0.U,     rij2        , rij4, rij6, 0.U, 0.U, 0.U)
    val fpuM_in11 = Seq(0.U, rijx, chargej, 0.U,     rij2        , rij2, rij6, 0.U, 0.U, 0.U)
    val fpuM_in20 = Seq(0.U, rijy,     0.U, 0.U, chargeij        ,  0.U,  0.U, 0.U, 0.U, 0.U)
    val fpuM_in21 = Seq(0.U, rijy,     0.U, 0.U, io.coulombFactor,  0.U,  0.U, 0.U, 0.U, 0.U)
    val fpuM_in30 = Seq(0.U, rijz,     0.U, 0.U, 0.U             ,  0.U,  0.U, 0.U, 0.U, 0.U)
    val fpuM_in31 = Seq(0.U, rijz,     0.U, 0.U, 0.U             ,  0.U,  0.U, 0.U, 0.U, 0.U)
    ...
    val fpuD_in0 = Seq(0.U, 0.U, 0.U, 0.U, 0.U, chargeijC, Bij ,   Aij, 0.U, 0.U)
    val fpuD_in1 = Seq(0.U, 0.U, 0.U, 0.U, 0.U, rijORrij2, rij6, rij12, 0.U, 0.U)
